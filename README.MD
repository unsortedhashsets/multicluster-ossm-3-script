...
- `DATA_PLANE` - `side-cars` or `ambient` (controls whether sidecar or ambient data plane is used).
...
export DATA_PLANE=side-cars            # or ambient
export ISTIO_VERSION=v1.27.3
